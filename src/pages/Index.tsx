        ...
        <div className="container mx-auto grid md:grid-cols-2 gap-10">
          <div>
            ...
            <div className="flex gap-4 mt-4">
              <a aria-label="Instagram" className="icon-pulse hover:text-primary transition-colors" href="https://www.instagram.com/seculinx/" target="_blank" rel="noopener noreferrer">
                <Instagram size={20} />
              </a>
              <a aria-label="LinkedIn" className="icon-pulse hover:text-primary transition-colors" href="https://www.linkedin.com/company/seculinx/?viewAsMember=true" target="_blank" rel="noopener noreferrer">
                <Linkedin size={20} />
              </a>
              <a aria-label="X" className="icon-pulse hover:text-primary transition-colors" href="https://x.com/seculinx" target="_blank" rel="noopener noreferrer">
                <Twitter size={20} />
              </a>
            </div>
          </div>
